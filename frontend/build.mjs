...
// Optional exploit-lab pair: both env vars must be set together; a lone one is
// a build error (a half-configured lab is worse than none). Unset → lab: null.
{
...
console.log(`  lab       ${config.lab ? config.lab.interlock + " / " + config.lab.vault : "(none — exploit-lab path inert)"}`);
