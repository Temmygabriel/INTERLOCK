...
#        push coverage under 100% — the exploit the demo reports to interlock_v3.
#
# PARTNER  Judged by ONE interlock_v3.py instance (v3-crosschain/genlayer/),
#          which on confirmed exploit emits a TRIP bridge message toward
#          BaseDemoVault on Base Sepolia instead of calling apply_pause here.
# ============================================================================
